...
$current_dir/../../statsiac -debug+ -lib:$current_dir/../../build,/usr/local/lib/nunit -t:library $current_dir/BroadcastingTests.boo -o:$current_dir/build/statsiac.Tests.dll
if [ $? -ne 0 ]; then
