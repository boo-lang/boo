...
namespace BooCompiler.Tests
{
	...
	public class GenericsTestFixture : AbstractCompilerTestCase
	{
		...
		{
			RunCompilerTestCase(@"e:\projects\boo\tests\testcases\net2\generics\array-enumerable-1.boo");
		}
		...
		{
			RunCompilerTestCase(@"e:\projects\boo\tests\testcases\net2\generics\generic-method-invocation-1.boo");
		}
		
		[Test]
		public void generic_method_invocation_2()
		{
			RunCompilerTestCase(@"e:\projects\boo\tests\testcases\net2\generics\generic-method-invocation-2.boo");
		}
		
		[Test]
		public void generic_ref_parameter()
		{
			RunCompilerTestCase(@"e:\projects\boo\tests\testcases\net2\generics\generic-ref-parameter.boo");
		}
		
		[Test]
		public void generic_type_resolution_1()
		{
			RunCompilerTestCase(@"e:\projects\boo\tests\testcases\net2\generics\generic-type-resolution-1.boo");
		}
		
		[Test]
		public void generic_type_resolution_2()
		{
			RunCompilerTestCase(@"e:\projects\boo\tests\testcases\net2\generics\generic-type-resolution-2.boo");
		}
