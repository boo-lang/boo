...
[TestFixture]
class CallablesIntegrationTestFixture(AbstractCompilerTestCase):
	...
	[Test]
	def @callables_as_ternary_operands():
		RunCompilerTestCase("callables-as-ternary-operands.boo")

	[Test]
	def @callables_as_ternay_operands_invocation():
	...
	[Test]
	def @overload_resolution_1():
		RunCompilerTestCase("overload-resolution-1.boo")

	[Test]
	def @overload_resolution_2():
