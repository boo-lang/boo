...
namespace Boo.Lang.Parser.Tests
{
	...
	[TestFixture]
	public class WSAParserV4RoundtripTestFixture : AbstractWSAParserV4TestFixture
	{
		void RunCompilerTestCase(string fname)
		{
			RunParserTestCaseV4(fname);
		}
		...
		[Test]
		public void member_references_1()
		{
			RunCompilerTestCase(@"member-references-1.boo");
		}
