	...
	protected final void mTEXT_ITEM(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		if ((LA(1)=='$') && (LA(2)=='s') && (LA(3)=='e')) {
			...
			match("$skip");
				            ...
				            text.setLength(_begin); text.append("_ttype = SKIP");
			...
			match("$getText");
						...
						text.setLength(_begin); text.append("self.text.getString(_begin)");
			...
			if ((LA(1)=='$') && (LA(2)=='n') && (LA(3)=='l')) {
				...
				throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());
				    ...
				    text.setLength(_begin); text.append("self.newline()"); 
 ...
 */
	...
	protected final void mML_COMMENT(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		do {
			// nongreedy exit test
			if ((LA(1)=='*') && (LA(2)=='/') && (true)) break _loop99;
			if ((LA(1)=='\r') && (LA(2)=='\n') && ((LA(3) >= '\u0003' && LA(3) <= '\u00ff'))) {
				match('\r');
				match('\n');
				_saveIndex=text.length();
