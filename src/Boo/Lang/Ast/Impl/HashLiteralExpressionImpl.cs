...
namespace Boo.Lang.Ast.Impl
{
	...
	public abstract class HashLiteralExpressionImpl : LiteralExpression
	{
		...
		{
			HashLiteralExpression clone = (HashLiteralExpression)System.Runtime.Serialization.FormatterServices.GetUninitializedObject(GetType());
		...
		override public bool Replace(Node existing, Node newNode)
		{
			...
			if (_items != null)
			{
				...
				if (null != item)
				{
					if (_items.Replace(item, (ExpressionPair)newNode))
					{
						return true;
					}
				}
