...
{	
	...
	public abstract class EnumMemberImpl : TypeMember
	{
		...
		{
			EnumMember clone = FormatterServices.GetUninitializedObject(typeof(EnumMember)) as EnumMember;
			...
			{
				clone._initializer = _initializer.Clone() as IntegerLiteralExpression;
