...
{	
	...
	public abstract class ImportImpl : Node
	{
		...
		{
			Import clone = FormatterServices.GetUninitializedObject(typeof(Import)) as Import;
			...
			{
				clone._assemblyReference = _assemblyReference.CloneNode();
				clone._assemblyReference.InitializeParent(clone);
			}

			if (null != _alias)
			{
				clone._alias = _alias.CloneNode();
