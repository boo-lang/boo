...
{	
	...
	public abstract class TupleTypeReferenceImpl : TypeReference
	{
		...
		{
			return Clone() as TupleTypeReference;
		}
		...
		{
			TupleTypeReference clone = FormatterServices.GetUninitializedObject(typeof(TupleTypeReference)) as TupleTypeReference;
			...
			{
				clone._elementType = _elementType.CloneNode();
