...
namespace Boo.Lang.Ast.Impl
{
	...
	public abstract class RetryStatementImpl : Statement
	{
		...
		protected RetryStatementImpl(LexicalInfo lexicalInfo) : base(lexicalInfo)
		{
 		}
		...
		new public RetryStatement CloneNode()
		{
			return (RetryStatement)Clone();
		}
		
		override public object Clone()
		{
			RetryStatement clone = (RetryStatement)System.Runtime.Serialization.FormatterServices.GetUninitializedObject(GetType());
