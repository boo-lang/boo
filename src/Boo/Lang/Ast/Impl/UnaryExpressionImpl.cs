...
namespace Boo.Lang.Ast.Impl
{
	...
	public abstract class UnaryExpressionImpl : Expression
	{
		...
		protected UnaryExpressionImpl(LexicalInfo info) : base(info)
		{
			InitializeFields();
		}
		...
		new public Boo.Lang.Ast.UnaryExpression CloneNode()
		{
			return Clone() as Boo.Lang.Ast.UnaryExpression;
		}
		...
		{
			Boo.Lang.Ast.UnaryExpression thisNode = (Boo.Lang.Ast.UnaryExpression)this;
		...
		override public bool Replace(Node existing, Node newNode)
		{
			...
			{
				this.Operand = ((Boo.Lang.Ast.Expression)newNode);
				return true;
			}
		...
		{
			Boo.Lang.Ast.UnaryExpression clone = (Boo.Lang.Ast.UnaryExpression)System.Runtime.Serialization.FormatterServices.GetUninitializedObject(typeof(Boo.Lang.Ast.UnaryExpression));
