...
{	
	...
	public abstract class UnaryExpressionImpl : Expression
	{
		...
		{
			return Clone() as UnaryExpression;
		}
		...
		{
			UnaryExpression clone = FormatterServices.GetUninitializedObject(typeof(UnaryExpression)) as UnaryExpression;
			...
			if (null != _operand)
			{
				clone._operand = _operand.CloneNode();
