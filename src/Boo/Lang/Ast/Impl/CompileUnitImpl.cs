...
// ast.py script on Wed Feb 11 15:00:29 2004
//
using System;
...
namespace Boo.Lang.Ast.Impl
{
	...
	public abstract class CompileUnitImpl : Node
	{
		...
		protected CompileUnitImpl(LexicalInfo lexicalInfo) : base(lexicalInfo)
		{
			_modules = new ModuleCollection(this);
 		}
		...
		{
			CompileUnit clone = (CompileUnit)System.Runtime.Serialization.FormatterServices.GetUninitializedObject(GetType());
		...
		override public bool Replace(Node existing, Node newNode)
		{
			...
			if (_modules != null)
			{
				...
				if (null != item)
				{
					if (_modules.Replace(item, (Module)newNode))
					{
						return true;
					}
				}
