...
{	
	...
	public abstract class CompileUnitImpl : Node
	{
		...
		{
			CompileUnit clone = FormatterServices.GetUninitializedObject(typeof(CompileUnit)) as CompileUnit;
			...
			if (null != _modules)
			{
				clone._modules = _modules.CloneNode();
