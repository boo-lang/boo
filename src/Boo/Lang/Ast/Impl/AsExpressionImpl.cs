...
// ast.py script on Wed Feb 11 12:57:34 2004
//
using System;
...
namespace Boo.Lang.Ast.Impl
{
	...
	public abstract class AsExpressionImpl : Expression
	{
		...
		protected AsExpressionImpl(LexicalInfo lexicalInfo) : base(lexicalInfo)
		{
 		}
		...
		{
			return (AsExpression)Clone();
		}
		
		override public object Clone()
		{
			AsExpression clone = (AsExpression)System.Runtime.Serialization.FormatterServices.GetUninitializedObject(GetType());
