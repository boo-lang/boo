...
{	
	...
	public abstract class DeclarationStatementImpl : Statement
	{
		...
		{
			return Clone() as DeclarationStatement;
		}
		...
		{
			DeclarationStatement clone = FormatterServices.GetUninitializedObject(typeof(DeclarationStatement)) as DeclarationStatement;
