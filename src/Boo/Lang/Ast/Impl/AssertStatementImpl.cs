...
{	
	...
	public abstract class AssertStatementImpl : Statement
	{
		...
		{
			return Clone() as AssertStatement;
		}
		...
		{
			AssertStatement clone = FormatterServices.GetUninitializedObject(typeof(AssertStatement)) as AssertStatement;
			...
			if (null != _message)
			{
				clone._message = _message.CloneNode();
				clone._message.InitializeParent(clone);
			}
