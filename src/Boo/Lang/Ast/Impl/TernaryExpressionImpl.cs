...
{	
	...
	public abstract class TernaryExpressionImpl : Expression
	{
		...
		{
			return Clone() as TernaryExpression;
		}
		...
		{
			TernaryExpression clone = FormatterServices.GetUninitializedObject(typeof(TernaryExpression)) as TernaryExpression;
			...
			if (null != _condition)
			{
				clone._condition = _condition.CloneNode();
				clone._condition.InitializeParent(clone);
			}

			if (null != _trueExpression)
			{
				clone._trueExpression = _trueExpression.CloneNode();
				clone._trueExpression.InitializeParent(clone);
			}

			if (null != _falseExpression)
			{
				clone._falseExpression = _falseExpression.CloneNode();
