...
{	
	...
	public abstract class NamespaceDeclarationImpl : Node
	{
		...
		{
			return Clone() as NamespaceDeclaration;
		}
		...
		{
			NamespaceDeclaration clone = FormatterServices.GetUninitializedObject(typeof(NamespaceDeclaration)) as NamespaceDeclaration;
