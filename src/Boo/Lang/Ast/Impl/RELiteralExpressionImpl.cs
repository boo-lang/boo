...
namespace Boo.Lang.Ast.Impl
{
	...
	public abstract class RELiteralExpressionImpl : LiteralExpression
	{
		...
		protected RELiteralExpressionImpl(LexicalInfo lexicalInfo) : base(lexicalInfo)
		{
 		}
		...
		{
			RELiteralExpression clone = (RELiteralExpression)System.Runtime.Serialization.FormatterServices.GetUninitializedObject(GetType());
