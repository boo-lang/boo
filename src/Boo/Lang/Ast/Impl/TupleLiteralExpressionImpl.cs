...
// ast.py script on Tue Feb 10 19:00:50 2004
//
using System;
...
namespace Boo.Lang.Ast.Impl
{
	...
	public abstract class TupleLiteralExpressionImpl : ListLiteralExpression
	{
		...
		protected TupleLiteralExpressionImpl(LexicalInfo lexicalInfo) : base(lexicalInfo)
		{
 		}
		...
		{
			return (TupleLiteralExpression)Clone();
		}
		
		override public object Clone()
		{
			TupleLiteralExpression clone = (TupleLiteralExpression)System.Runtime.Serialization.FormatterServices.GetUninitializedObject(GetType());
