...
{	
	...
	public abstract class TryStatementImpl : Statement
	{
		...
		{
			TryStatement clone = FormatterServices.GetUninitializedObject(typeof(TryStatement)) as TryStatement;
