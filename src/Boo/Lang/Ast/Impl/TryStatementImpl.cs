...
namespace Boo.Lang.Ast.Impl
{
	...
	public abstract class TryStatementImpl : Statement
	{
		...
		protected TryStatementImpl(LexicalInfo info) : base(info)
		{
			InitializeFields();
		}
		...
		new public Boo.Lang.Ast.TryStatement CloneNode()
		{
			return Clone() as Boo.Lang.Ast.TryStatement;
		}
		...
		{
			Boo.Lang.Ast.TryStatement thisNode = (Boo.Lang.Ast.TryStatement)this;
		...
		override public bool Replace(Node existing, Node newNode)
		{
			...
			{
				this.ProtectedBlock = ((Boo.Lang.Ast.Block)newNode);
				return true;
			}

			if (_exceptionHandlers != null)
			{
				Boo.Lang.Ast.ExceptionHandler item = existing as Boo.Lang.Ast.ExceptionHandler;
				if (null != item)
				{
					if (_exceptionHandlers.Replace(item, (Boo.Lang.Ast.ExceptionHandler)newNode))
					{
						return true;
					}
				}
			...
			{
				this.SuccessBlock = ((Boo.Lang.Ast.Block)newNode);
				return true;
			}

			if (_ensureBlock == existing)
			{
				this.EnsureBlock = ((Boo.Lang.Ast.Block)newNode);
				return true;
			}
		...
		{
			Boo.Lang.Ast.TryStatement clone = (Boo.Lang.Ast.TryStatement)System.Runtime.Serialization.FormatterServices.GetUninitializedObject(typeof(Boo.Lang.Ast.TryStatement));
			...
			if (null != _successBlock)
			{
				...
				clone._successBlock.InitializeParent(clone);
			}
