...
{	
	...
	public abstract class InterfaceDefinitionImpl : TypeDefinition
	{
		...
		{
			return Clone() as InterfaceDefinition;
		}
		...
		{
			InterfaceDefinition clone = FormatterServices.GetUninitializedObject(typeof(InterfaceDefinition)) as InterfaceDefinition;
