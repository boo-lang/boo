...
{	
	...
	public abstract class ReferenceExpressionImpl : Expression
	{
		...
		{
			return Clone() as ReferenceExpression;
		}
		...
		{
			ReferenceExpression clone = FormatterServices.GetUninitializedObject(typeof(ReferenceExpression)) as ReferenceExpression;
