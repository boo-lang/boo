...
// ast.py script on Sun Jan 11 23:16:56 2004
//
using System;
...
namespace Boo.Ast.Impl
{
	...
	public abstract class IteratorExpressionImpl : Expression
	{
		...
		protected IteratorExpressionImpl(antlr.Token token, Expression expression, Expression iterator, StatementModifier filter) : base(token)
		{
			_declarations = new DeclarationCollection(this);
 			Expression = expression;
			Iterator = iterator;
		...
		internal IteratorExpressionImpl(antlr.Token token) : base(token)
		{
			_declarations = new DeclarationCollection(this);
 		}
		
		internal IteratorExpressionImpl(Node lexicalInfoProvider) : base(lexicalInfoProvider)
		{
			_declarations = new DeclarationCollection(this);
 		}
