...
using Boo.Ast.Parsing.Util;
	...
	internal void LeaveSkipWhitespaceRegion()
	{
		...
		private void initialize()
		{
			...
			literals.Add("otherwise", 49);
			literals.Add("retry", 58);
			literals.Add("internal", 41);
			literals.Add("class", 28);
			literals.Add("private", 55);
			literals.Add("def", 30);
			literals.Add("if", 43);
			literals.Add("pass", 50);
			literals.Add("ensure", 32);
			literals.Add("unless", 67);
			literals.Add("self", 60);
			literals.Add("when", 71);
			literals.Add("success", 63);
			literals.Add("in", 44);
			literals.Add("enum", 33);
			literals.Add("package", 51);
			literals.Add("continue", 26);
			literals.Add("from", 35);
			literals.Add("given", 39);
			literals.Add("while", 72);
			literals.Add("as", 24);
			literals.Add("not", 46);
			literals.Add("using", 68);
			literals.Add("false", 37);
			literals.Add("super", 61);
			literals.Add("protected", 54);
			literals.Add("null", 47);
			literals.Add("or", 48);
			literals.Add("constructor", 29);
			literals.Add("true", 66);
			literals.Add("void", 70);
			literals.Add("interface", 40);
			literals.Add("catch", 27);
			literals.Add("kindof", 45);
			literals.Add("raise", 56);
			literals.Add("break", 25);
			literals.Add("final", 34);
			literals.Add("for", 36);
			literals.Add("try", 64);
			literals.Add("yield", 73);
			literals.Add("else", 31);
			literals.Add("return", 57);
			literals.Add("public", 53);
			literals.Add("static", 62);
			literals.Add("transient", 65);
			literals.Add("is", 42);
			literals.Add("and", 23);
			literals.Add("property", 52);
			literals.Add("until", 69);
			literals.Add("set", 59);
			literals.Add("get", 38);
		}
	...
	public void mINT(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
{
		...
		for (;;)
		{
			...
			{
				if (_cnt261 >= 1) { goto _loop261_breakloop; } else { throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());; }
			}
	...
	protected void mRE_LITERAL(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
{
		...
		for (;;)
		{
			...
			{
				if (_cnt325 >= 1) { goto _loop325_breakloop; } else { throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());; }
			}
	...
	protected void mTRIPLE_QUOTED_STRING(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
{
		...
		{    // ( ... )*
			...
			{
				// nongreedy exit test
				if ((LA(1)=='"') && (LA(2)=='"') && (LA(3)=='"')) goto _loop296_breakloop;
	...
	public void mWS(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
{
		...
		for (;;)
		{
			...
			default:
			{
				if (_cnt315 >= 1) { goto _loop315_breakloop; } else { throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());; }
			}
			break; }
			_cnt315++;
		}
