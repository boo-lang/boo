	...
	public 	class BooLexer : antlr.CharScanner	, TokenStream
	 {
		...
		public const int ESCAPED_EXPRESSION = 109;
		public const int DQS_ESC = 110;
		public const int SQS_ESC = 111;
		public const int SESC = 112;
		public const int RE_CHAR = 113;
		public const int RE_ESC = 114;
		public const int ID_LETTER = 115;
		public const int DIGIT = 116;
	...
	public void mINT(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
{
		...
		for (;;)
		{
			...
			{
				if (_cnt301 >= 1) { goto _loop301_breakloop; } else { throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());; }
			}
						...
						{
							{
								...
								for (;;)
								{
									...
									{
										if (_cnt308 >= 1) { goto _loop308_breakloop; } else { throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());; }
									}
		...
		match('.');
		{
			if (((LA(1) >= '0' && LA(1) <= '9')))
			{
				...
				for (;;)
				{
					...
					{
						if (_cnt314 >= 1) { goto _loop314_breakloop; } else { throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());; }
					}
	...
	protected void mRE_LITERAL(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
{
		...
		for (;;)
		{
			...
			{
				if (_cnt389 >= 1) { goto _loop389_breakloop; } else { throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());; }
			}
	...
	protected void mTRIPLE_QUOTED_STRING(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
{
		...
		{    // ( ... )*
			...
			{
				// nongreedy exit test
				if ((LA(1)=='"') && (LA(2)=='"') && (LA(3)=='"')) goto _loop356_breakloop;
	...
	public void mDOUBLE_QUOTED_STRING(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
{
		...
		text.Length = _saveIndex;
		{
			...
			else if ((tokenSet_3_.member(LA(1))) && (true) && (true)) {
				{
					{    // ( ... )*
						for (;;)
						{
							bool synPredMatched362 = false;
							if (((LA(1)=='$') && (LA(2)=='{') && (tokenSet_3_.member(LA(3)))))
							{
								int _m362 = mark();
							...
							else if ((tokenSet_4_.member(LA(1))) && (tokenSet_3_.member(LA(2))) && (true)) {
								{
									match(tokenSet_4_);
								}
							}
	...
	public void mWS(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
{
		...
		for (;;)
		{
			...
			default:
			{
				if (_cnt375 >= 1) { goto _loop375_breakloop; } else { throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());; }
			}
			break; }
			_cnt375++;
		}
